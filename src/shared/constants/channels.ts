...
export const IPC_CHANNELS = {
  ...
  HOT_REPORT_DELETE: 'hot:report:delete',
  HOT_REPORT_REVEAL: 'hot:report:reveal',
  HOT_CONFIG_SAVE: 'hot:config:save',
  HOT_TIMELINE_PRESETS: 'hot:timeline:presets',
  HOT_AI_SUMMARIZE: 'hot:ai:summarize',
  HOT_NOTIFICATION_SEND: 'hot:notification:send',
  ...
  COMMENT_RESULT_LIST: 'comment:result:list',
  COMMENT_AI_REPLY_GENERATE: 'comment:ai-reply:generate',
  ...
  COMMENT_MEDIACRAWLER_CONFIG_GET: 'comment:mediacrawler:config:get',
  COMMENT_MEDIACRAWLER_CONFIG_SAVE: 'comment:mediacrawler:config:save',
  COMMENT_MEDIACRAWLER_TEST: 'comment:mediacrawler:test',
  COMMENT_MEDIACRAWLER_RUN: 'comment:mediacrawler:run',
