...
>
> V1.1 增强 Spec（SPEC-023 ~ SPEC-028）见 [v1.1-enhancements.md](v1.1-enhancements.md)
...
| 现状参考 | 当前仓库实现情况请查看 `docs/overview/current-status.md` |
| 架构参考 | 架构分层与调用链路请查看 `docs/architecture/architecture.md` |
| 增量规格 | 自动化、Task-as-Code、MCP、Headless / Remote Runner 与 Runner Scheduler 已拆到专项 specs |
