...
| 方向 | 状态 | 关联文档 |
| --- | --- | --- |
| A · Headless Runner | 草案待评审 | [specs/headless-runner-v1.md](../specs/headless-runner-v1.md) |
| B · Task-as-Code | 草案待评审 | [specs/task-as-code-v1.md](../specs/task-as-code-v1.md) |
| C · MCP 集成 | 草案待评审 | [specs/mcp-integration-v1.md](../specs/mcp-integration-v1.md) |
| D · 数据出口/可观测性 | 仅本文档 | — |
